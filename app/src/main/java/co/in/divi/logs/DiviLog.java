...
public class DiviLog implements Parcelable {
    ...
    // new properties
    public Location.LOCATION_SUBTYPE resourceType;
    ...
    public DiviLog(String uid, String token, String uri, int type, Location.LOCATION_SUBTYPE locType) {
        this.uid = uid;
        this.token = token;
        this.uri = uri;
        this.type = type;
    ...
    public static DiviLog fromCursor(Cursor cursor) {
        ...
        log.resourceType = Location.LOCATION_SUBTYPE.valueOf(cursor.getString(resourceType_index));
    ...
    private DiviLog(Parcel in) {
        ...
        token = strs[1];
        uri = strs[2];
        resourceType = Location.LOCATION_SUBTYPE.valueOf(strs[3]);
        type = in.readInt();
