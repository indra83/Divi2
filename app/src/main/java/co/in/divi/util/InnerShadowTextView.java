...
public class InnerShadowTextView extends TextView {
	...
	public InnerShadowTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs);
	}
	public InnerShadowTextView(Context context, AttributeSet attrs, int defStyle) {
