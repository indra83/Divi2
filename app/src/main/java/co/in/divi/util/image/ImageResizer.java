...
public class ImageResizer extends ImageWorker {
	 ...
	 * @return
	 */
	private Bitmap processBitmap(File imageFile) {
		if (BuildConfig.DEBUG) {
			Log.d(TAG, "processBitmap - " + imageFile);
		}
		return decodeSampledBitmapFromFile(imageFile.getAbsolutePath(), mImageWidth, mImageHeight, getImageCache());
